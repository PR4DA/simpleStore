...
<div class="container-wrapper">
    <div class="container">
        ...
        <div class="form-group">
            <label for="name">Name</label><form:errors path="customerName" cssStyle="color: #d43f3a"/>
        ...
        <div class="form-group">
            <label for="password">Password</label><form:errors path="password" cssStyle="color: #d43f3a"/>
